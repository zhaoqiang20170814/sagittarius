...
import com.dongfangyuxin.dao.common.bean.ExpenseTypeInfoBeanExample.Criteria;
import com.dongfangyuxin.dao.common.bean.ExpenseTypeInfoBeanExample.Criterion;
...
public class ExpenseTypeInfoBeanSqlProvider {
    ...
    public String countByExample(ExpenseTypeInfoBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("expense_type_info");
    ...
    public String deleteByExample(ExpenseTypeInfoBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("expense_type_info");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(ExpenseTypeInfoBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("expense_type_info");
