...
public interface UserBeanMapper {
    ...
    @Insert({
            ...
            "PASSWORD, SEX, AGE, ",
            "POST, DEPARTMENT, CONTACT, ",
            "ID_NUMBER, S_CREATOR, S_CREATE_DATE, ",
            "S_OPERATOR, S_OPERATOR_DATE)",
            "values (#{code,jdbcType=CHAR}, #{name,jdbcType=VARCHAR}, ",
            "#{password,jdbcType=VARCHAR}, #{sex,jdbcType=CHAR}, #{age,jdbcType=INTEGER}, ",
            "#{post,jdbcType=CHAR}, #{department,jdbcType=CHAR}, #{contact,jdbcType=VARCHAR}, ",
    ...
    @Select({
            "select",
            "ID, CODE, NAME, PASSWORD, SEX, AGE, POST, DEPARTMENT, CONTACT, ID_NUMBER, S_CREATOR, ",
