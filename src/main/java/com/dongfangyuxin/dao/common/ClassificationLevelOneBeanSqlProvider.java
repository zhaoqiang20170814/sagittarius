...
import com.dongfangyuxin.dao.common.bean.ClassificationLevelOneBeanExample.Criteria;
import com.dongfangyuxin.dao.common.bean.ClassificationLevelOneBeanExample.Criterion;
import com.dongfangyuxin.dao.common.bean.ClassificationLevelOneBeanExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ClassificationLevelOneBeanSqlProvider {

    public String countByExample(ClassificationLevelOneBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("classification_level_1");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(ClassificationLevelOneBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("classification_level_1");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(ClassificationLevelOneBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("classification_level_1");
    ...
    public String selectByExample(ClassificationLevelOneBeanExample example) {
        SQL sql = new SQL();
        ...
        sql.FROM("classification_level_1");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ClassificationLevelOneBean record = (ClassificationLevelOneBean) parameter.get("record");
        ClassificationLevelOneBeanExample example = (ClassificationLevelOneBeanExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("classification_level_1");
    ...
    public String updateByPrimaryKeySelective(ClassificationLevelOneBean record) {
        SQL sql = new SQL();
        sql.UPDATE("classification_level_1");
    ...
    protected void applyWhere(SQL sql, ClassificationLevelOneBeanExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
