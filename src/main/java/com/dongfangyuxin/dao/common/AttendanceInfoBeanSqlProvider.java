...
import com.dongfangyuxin.dao.common.bean.AttendanceInfoBean;
import com.dongfangyuxin.dao.common.bean.AttendanceInfoBeanExample.Criteria;
import com.dongfangyuxin.dao.common.bean.AttendanceInfoBeanExample.Criterion;
import com.dongfangyuxin.dao.common.bean.AttendanceInfoBeanExample;
...
public class AttendanceInfoBeanSqlProvider {
    ...
    public String countByExample(AttendanceInfoBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("attendance_info");
    ...
    public String deleteByExample(AttendanceInfoBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("attendance_info");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(AttendanceInfoBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("attendance_info");
