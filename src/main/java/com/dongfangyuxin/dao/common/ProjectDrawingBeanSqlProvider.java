...
import com.dongfangyuxin.dao.common.bean.ProjectDrawingBeanExample.Criteria;
import com.dongfangyuxin.dao.common.bean.ProjectDrawingBeanExample.Criterion;
import com.dongfangyuxin.dao.common.bean.ProjectDrawingBeanExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ProjectDrawingBeanSqlProvider {

    public String countByExample(ProjectDrawingBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("project_drawing");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(ProjectDrawingBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("project_drawing");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(ProjectDrawingBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("project_drawing");
        
        if (record.getProjectCode() != null) {
            sql.VALUES("PROJECT_CODE", "#{projectCode,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(ProjectDrawingBeanExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ProjectDrawingBean record = (ProjectDrawingBean) parameter.get("record");
        ProjectDrawingBeanExample example = (ProjectDrawingBeanExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("project_drawing");
        ...
        if (record.getProjectCode() != null) {
            sql.SET("PROJECT_CODE = #{record.projectCode,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(ProjectDrawingBean record) {
        SQL sql = new SQL();
        sql.UPDATE("project_drawing");
        
        if (record.getProjectCode() != null) {
            sql.SET("PROJECT_CODE = #{projectCode,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(SQL sql, ProjectDrawingBeanExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
