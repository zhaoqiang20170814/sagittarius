...
import com.dongfangyuxin.dao.common.bean.MaterialRequisitionDetailBeanExample.Criteria;
import com.dongfangyuxin.dao.common.bean.MaterialRequisitionDetailBeanExample.Criterion;
import com.dongfangyuxin.dao.common.bean.MaterialRequisitionDetailBeanExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class MaterialRequisitionDetailBeanSqlProvider {

    public String countByExample(MaterialRequisitionDetailBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("material_requisition_detail");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(MaterialRequisitionDetailBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("material_requisition_detail");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(MaterialRequisitionDetailBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("material_requisition_detail");
    ...
    public String selectByExample(MaterialRequisitionDetailBeanExample example) {
        SQL sql = new SQL();
        ...
        sql.FROM("material_requisition_detail");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        MaterialRequisitionDetailBean record = (MaterialRequisitionDetailBean) parameter.get("record");
        MaterialRequisitionDetailBeanExample example = (MaterialRequisitionDetailBeanExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("material_requisition_detail");
    ...
    public String updateByPrimaryKeySelective(MaterialRequisitionDetailBean record) {
        SQL sql = new SQL();
        sql.UPDATE("material_requisition_detail");
    ...
    protected void applyWhere(SQL sql, MaterialRequisitionDetailBeanExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
