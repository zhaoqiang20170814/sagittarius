...
import com.dongfangyuxin.dao.common.bean.MaterialReturningDetailBeanExample.Criteria;
import com.dongfangyuxin.dao.common.bean.MaterialReturningDetailBeanExample.Criterion;
import com.dongfangyuxin.dao.common.bean.MaterialReturningDetailBeanExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class MaterialReturningDetailBeanSqlProvider {

    public String countByExample(MaterialReturningDetailBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("material_returning_detail");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(MaterialReturningDetailBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("material_returning_detail");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(MaterialReturningDetailBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("material_returning_detail");
    ...
    public String selectByExample(MaterialReturningDetailBeanExample example) {
        SQL sql = new SQL();
        ...
        sql.FROM("material_returning_detail");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        MaterialReturningDetailBean record = (MaterialReturningDetailBean) parameter.get("record");
        MaterialReturningDetailBeanExample example = (MaterialReturningDetailBeanExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("material_returning_detail");
    ...
    public String updateByPrimaryKeySelective(MaterialReturningDetailBean record) {
        SQL sql = new SQL();
        sql.UPDATE("material_returning_detail");
    ...
    protected void applyWhere(SQL sql, MaterialReturningDetailBeanExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
