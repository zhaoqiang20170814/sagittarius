...
public interface MaterialRequisitionDetailBeanMapper {
     ...
     */
    @Delete({
        "delete from sagittarius..material_requisition_detail",
     ...
     */
    @Insert({
        "insert into sagittarius..material_requisition_detail (CODE, TASK_CODE, ",
        "QUANTITY, AMOUNT, ",
    ...
    @Select({
        ...
        "S_OPERATOR_DATE",
        "from sagittarius..material_requisition_detail",
        "where ID = #{id,jdbcType=INTEGER}"
    })
    @Results({
        @Result(column="ID", property="id", jdbcType=JdbcType.INTEGER, id=true),
     ...
     */
    @Update({
        "update sagittarius..material_requisition_detail",
