...
public interface ExpenseInfoDetailBeanMapper {
     ...
     */
    @Delete({
        "delete from sagittarius..expense_info_detail",
     ...
     */
    @Insert({
        "insert into sagittarius..expense_info_detail (CODE, TYPE, AMOUNT, ",
    ...
    @Select({
        ...
        "from sagittarius..expense_info_detail",
        "where ID = #{id,jdbcType=INTEGER}"
    })
    @Results({
        @Result(column="ID", property="id", jdbcType=JdbcType.INTEGER, id=true),
     ...
     */
    @Update({
        "update sagittarius..expense_info_detail",
