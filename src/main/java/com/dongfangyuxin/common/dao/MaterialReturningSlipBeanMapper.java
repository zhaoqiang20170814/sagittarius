...
public interface MaterialReturningSlipBeanMapper {
     ...
     */
    @Delete({
        "delete from sagittarius..material_returning_slip",
     ...
     */
    @Insert({
        "insert into sagittarius..material_returning_slip (CODE, TASK_CODE, ",
    ...
    @Select({
        ...
        "from sagittarius..material_returning_slip",
        "where ID = #{id,jdbcType=INTEGER}"
    })
    @Results({
        @Result(column="ID", property="id", jdbcType=JdbcType.INTEGER, id=true),
     ...
     */
    @Update({
        "update sagittarius..material_returning_slip",
