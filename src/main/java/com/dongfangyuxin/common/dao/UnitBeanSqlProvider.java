...
import com.dongfangyuxin.common.dao.bean.UnitBeanExample.Criteria;
import com.dongfangyuxin.common.dao.bean.UnitBeanExample.Criterion;
import com.dongfangyuxin.common.dao.bean.UnitBeanExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class UnitBeanSqlProvider {

    public String countByExample(UnitBeanExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(UnitBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("unit");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(UnitBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("unit");
    ...
    public String selectByExample(UnitBeanExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        UnitBean record = (UnitBean) parameter.get("record");
        UnitBeanExample example = (UnitBeanExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(UnitBean record) {
        SQL sql = new SQL();
        sql.UPDATE("unit");
    ...
    protected void applyWhere(SQL sql, UnitBeanExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
