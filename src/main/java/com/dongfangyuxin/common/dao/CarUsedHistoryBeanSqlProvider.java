...
public class CarUsedHistoryBeanSqlProvider {
     ...
     * This method corresponds to the database table sagittarius..car_used_history
     *
     * @mbg.generated Tue Jul 11 00:06:29 CST 2017
     */
    public String countByExample(CarUsedHistoryBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sagittarius..car_used_history");
    ...
    public String deleteByExample(CarUsedHistoryBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sagittarius..car_used_history");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(CarUsedHistoryBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("sagittarius..car_used_history");
    ...
    public String selectByExample(CarUsedHistoryBeanExample example) {
        ...
        sql.FROM("sagittarius..car_used_history");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        SQL sql = new SQL();
        sql.UPDATE("sagittarius..car_used_history");
