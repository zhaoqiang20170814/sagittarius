...
import com.dongfangyuxin.common.dao.bean.MaterialRequisitionBeanExample.Criteria;
import com.dongfangyuxin.common.dao.bean.MaterialRequisitionBeanExample.Criterion;
import com.dongfangyuxin.common.dao.bean.MaterialRequisitionBeanExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class MaterialRequisitionBeanSqlProvider {

    public String countByExample(MaterialRequisitionBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("material_requisition");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(MaterialRequisitionBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("material_requisition");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(MaterialRequisitionBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("material_requisition");
    ...
    public String selectByExample(MaterialRequisitionBeanExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        MaterialRequisitionBean record = (MaterialRequisitionBean) parameter.get("record");
        MaterialRequisitionBeanExample example = (MaterialRequisitionBeanExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("material_requisition");
    ...
    public String updateByPrimaryKeySelective(MaterialRequisitionBean record) {
        SQL sql = new SQL();
        sql.UPDATE("material_requisition");
    ...
    protected void applyWhere(SQL sql, MaterialRequisitionBeanExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
