...
public class MaterialRequisitionDetailBeanSqlProvider {
     ...
     * This method corresponds to the database table sagittarius..material_requisition_detail
     *
     * @mbg.generated Tue Jul 11 00:06:29 CST 2017
     */
    public String countByExample(MaterialRequisitionDetailBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sagittarius..material_requisition_detail");
    ...
    public String deleteByExample(MaterialRequisitionDetailBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sagittarius..material_requisition_detail");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(MaterialRequisitionDetailBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("sagittarius..material_requisition_detail");
    ...
    public String selectByExample(MaterialRequisitionDetailBeanExample example) {
        ...
        sql.FROM("sagittarius..material_requisition_detail");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        SQL sql = new SQL();
        sql.UPDATE("sagittarius..material_requisition_detail");
