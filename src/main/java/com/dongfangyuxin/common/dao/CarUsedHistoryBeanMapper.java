...
public interface CarUsedHistoryBeanMapper {
     ...
     */
    @Delete({
        "delete from sagittarius..car_used_history",
     ...
     */
    @Insert({
        "insert into sagittarius..car_used_history (CAR_NUMBER, TASK_CODE, ",
        "OPERATOR, USE_TIME, ",
    ...
    @Select({
        ...
        "from sagittarius..car_used_history",
        "where ID = #{id,jdbcType=INTEGER}"
    })
    @Results({
        @Result(column="ID", property="id", jdbcType=JdbcType.INTEGER, id=true),
     ...
     */
    @Update({
        "update sagittarius..car_used_history",
