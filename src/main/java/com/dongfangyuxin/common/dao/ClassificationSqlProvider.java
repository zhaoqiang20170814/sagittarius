...
import com.dongfangyuxin.common.dao.bean.ClassificationExample.Criteria;
import com.dongfangyuxin.common.dao.bean.ClassificationExample.Criterion;
...
public class ClassificationSqlProvider {
    ...
    public String countByExample(ClassificationExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("classification");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(ClassificationExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("classification");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(Classification record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("classification");
    ...
    public String selectByExample(ClassificationExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Classification record = (Classification) parameter.get("record");
        ClassificationExample example = (ClassificationExample) parameter.get("example");
    ...
    protected void applyWhere(SQL sql, ClassificationExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
