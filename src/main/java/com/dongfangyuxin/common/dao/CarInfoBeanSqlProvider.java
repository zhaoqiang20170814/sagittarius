...
public class CarInfoBeanSqlProvider {
     ...
     * This method corresponds to the database table sagittarius..car_info
     *
     * @mbg.generated Tue Jul 11 00:06:29 CST 2017
     */
    public String countByExample(CarInfoBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sagittarius..car_info");
    ...
    public String deleteByExample(CarInfoBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sagittarius..car_info");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(CarInfoBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("sagittarius..car_info");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        SQL sql = new SQL();
        sql.UPDATE("sagittarius..car_info");
