...
import com.dongfangyuxin.common.dao.bean.TaskBeanExample.Criteria;
import com.dongfangyuxin.common.dao.bean.TaskBeanExample.Criterion;
import com.dongfangyuxin.common.dao.bean.TaskBeanExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class TaskBeanSqlProvider {

    public String countByExample(TaskBeanExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(TaskBeanExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(TaskBean record) {
        SQL sql = new SQL();
        ...
        if (record.getLeadingOfficial() != null) {
            sql.VALUES("LEADING_OFFICIAL", "#{leadingOfficial,jdbcType=VARCHAR}");
        }
        
        if (record.getParticipant() != null) {
            sql.VALUES("PARTICIPANT", "#{participant,jdbcType=VARCHAR}");
        }
        ...
        if (record.getDrawing() != null) {
            sql.VALUES("DRAWING", "#{drawing,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(TaskBeanExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TaskBean record = (TaskBean) parameter.get("record");
        TaskBeanExample example = (TaskBeanExample) parameter.get("example");
        ...
        if (record.getLeadingOfficial() != null) {
            sql.SET("LEADING_OFFICIAL = #{record.leadingOfficial,jdbcType=VARCHAR}");
        }
        
        if (record.getParticipant() != null) {
            sql.SET("PARTICIPANT = #{record.participant,jdbcType=VARCHAR}");
        }
        
        if (record.getTaskStatus() != null) {
            sql.SET("TASK_STATUS = #{record.taskStatus,jdbcType=CHAR}");
        }
        
        if (record.getDrawing() != null) {
            sql.SET("DRAWING = #{record.drawing,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(TaskBean record) {
        SQL sql = new SQL();
        sql.UPDATE("task");
        ...
        if (record.getLeadingOfficial() != null) {
            sql.SET("LEADING_OFFICIAL = #{leadingOfficial,jdbcType=VARCHAR}");
        }
        
        if (record.getParticipant() != null) {
            sql.SET("PARTICIPANT = #{participant,jdbcType=VARCHAR}");
        }
        ...
        if (record.getDrawing() != null) {
            sql.SET("DRAWING = #{drawing,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(SQL sql, TaskBeanExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
