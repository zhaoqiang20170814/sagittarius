...
public class MaterialReturningSlipBeanSqlProvider {
     ...
     * This method corresponds to the database table sagittarius..material_returning_slip
     *
     * @mbg.generated Tue Jul 11 00:06:29 CST 2017
     */
    public String countByExample(MaterialReturningSlipBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sagittarius..material_returning_slip");
    ...
    public String deleteByExample(MaterialReturningSlipBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sagittarius..material_returning_slip");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(MaterialReturningSlipBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("sagittarius..material_returning_slip");
    ...
    public String selectByExample(MaterialReturningSlipBeanExample example) {
        ...
        sql.FROM("sagittarius..material_returning_slip");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        SQL sql = new SQL();
        sql.UPDATE("sagittarius..material_returning_slip");
