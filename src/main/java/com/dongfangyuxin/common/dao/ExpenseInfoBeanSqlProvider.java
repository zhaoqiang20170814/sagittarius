...
import com.dongfangyuxin.common.dao.bean.ExpenseInfoBeanExample.Criteria;
import com.dongfangyuxin.common.dao.bean.ExpenseInfoBeanExample.Criterion;
import com.dongfangyuxin.common.dao.bean.ExpenseInfoBeanExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ExpenseInfoBeanSqlProvider {

    public String countByExample(ExpenseInfoBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("expense_info");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(ExpenseInfoBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("expense_info");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(ExpenseInfoBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("expense_info");
    ...
    public String selectByExample(ExpenseInfoBeanExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ExpenseInfoBean record = (ExpenseInfoBean) parameter.get("record");
        ExpenseInfoBeanExample example = (ExpenseInfoBeanExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("expense_info");
    ...
    public String updateByPrimaryKeySelective(ExpenseInfoBean record) {
        SQL sql = new SQL();
        sql.UPDATE("expense_info");
    ...
    protected void applyWhere(SQL sql, ExpenseInfoBeanExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
