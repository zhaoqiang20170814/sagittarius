...
public class ExpenseInfoDetailBeanSqlProvider {
     ...
     * This method corresponds to the database table sagittarius..expense_info_detail
     *
     * @mbg.generated Tue Jul 11 00:06:29 CST 2017
     */
    public String countByExample(ExpenseInfoDetailBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sagittarius..expense_info_detail");
    ...
    public String deleteByExample(ExpenseInfoDetailBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sagittarius..expense_info_detail");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(ExpenseInfoDetailBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("sagittarius..expense_info_detail");
    ...
    public String selectByExample(ExpenseInfoDetailBeanExample example) {
        ...
        sql.FROM("sagittarius..expense_info_detail");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        SQL sql = new SQL();
        sql.UPDATE("sagittarius..expense_info_detail");
