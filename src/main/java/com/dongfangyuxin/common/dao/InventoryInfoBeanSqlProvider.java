...
public class InventoryInfoBeanSqlProvider {
    ...
    public String countByExample(InventoryInfoBeanExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sagittarius..inventory_info");
    ...
    public String deleteByExample(InventoryInfoBeanExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sagittarius..inventory_info");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(InventoryInfoBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("sagittarius..inventory_info");
    ...
    public String selectByExample(InventoryInfoBeanExample example) {
        ...
        sql.FROM("sagittarius..inventory_info");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        SQL sql = new SQL();
        sql.UPDATE("sagittarius..inventory_info");
