...
import com.dongfangyuxin.common.dao.bean.ProjectDrawingBeanExample.Criteria;
import com.dongfangyuxin.common.dao.bean.ProjectDrawingBeanExample.Criterion;
...
public class ProjectDrawingBeanSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getCode() != null) {
            sql.SET("CODE = #{record.code,jdbcType=INTEGER}");
        }
